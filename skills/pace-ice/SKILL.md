---
name: pace-ice
description: Use when working on Georgia Tech PACE ICE — "ICE", login-ice, instructional or coursework workloads, and grading workflows. Always pair with slurm-core for portable Slurm; not for Phoenix (that's pace-phoenix).
---
